...
function SelectValue({
  ...
  return (
    <SelectPrimitive.Value 
      ...
      className={cn("truncate whitespace-nowrap overflow-hidden text-ellipsis", className)}
      {...props} 
    />
  )
}
